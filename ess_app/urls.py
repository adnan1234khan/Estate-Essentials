...
urlpatterns=[
    ...
    path("rented_view/",views.renter_view,name="rented_view"),
    ...
    path("vastu_editprofile/",vastu_views.vastu_editprofile,name="vastu_editprofile"),
    ...
    path("client_validate/",client_views.client_validate,name="client_validate"),
