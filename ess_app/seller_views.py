...
def seller_property(request):
     ...
     if request.method=='POST':
        ...
        seller=Seller(user_id=owner_id,property_type=owner_property,seller_price=price,facilities=facilities,city=city,address=address,contact=contact,picture=pictures)
        seller.save()#to save data into contact table
        print("data saved")
        messages.success(request,"Thank you for Adding Property Deatils")
