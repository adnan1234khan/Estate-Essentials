...
class Seller_Admin(admin.ModelAdmin):
    list_display=('user_id','property_type','seller_price','facilities','city','address','contact','date')
    search_fields=('property_type','seller_price','date')
    list_filter=['property_type','seller_price','date']
